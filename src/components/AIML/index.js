    ...
    <>
      ...
      <div className="main-web-dynamic1">
        <div className="main-web-dynamic">
          <img
            src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697563450/robot-handshake-human-background-futuristic-digital-age_eaggvk.jpg"
            className="dwaed"
            alt="ed"
          />
        ...
        <div className="desc1">
          ...
          <Slide direction="right" delay={1}>
            <img
              src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697563469/ai-chip-artificial-intelligence-future-technology-innovation_hr2lep.jpg"
              className="img-w"
              alt="d"
            />
          </Slide>
        ...
        <div className="why1">
          ...
          <div className="why-img-des1">
            ...
            <Slide direction="right" delay={1}>
              <img
                src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697563480/20945590_it9upc.jpg"
                alt="img22"
                className="img20"
              />
            </Slide>
          ...
          <div className="fea-why1">
            ...
            <Slide direction="right" delay={1}>
              <img
                src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697563484/6503600_npuo4n.jpg"
                alt="img2"
                className="img32"
              />
            </Slide>
