    ...
    <>
      ...
      <div className="main-web-dynamic1">
        <div className="main-web-dynamic">
          <img
            src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697483676/pexels-marta-wave-5875899_acwx1w.jpg"
            className="dwaed"
            alt="ed"
          />
        ...
        <div className="desc1">
          ...
          <Slide direction="right" delay={1}>
            <img
              src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697562661/marketing-creative-collage-with-phone_zvwqxj.jpg"
              className="img-w"
              alt="d"
            />
          </Slide>
        ...
        <div className="why1">
          ...
          <div className="why-img-des1">
            ...
            <Slide direction="right" delay={1}>
              <img
                src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697562665/3684396_ovxupf.jpg"
                alt="img22"
                className="img20"
              />
            </Slide>
          ...
          <div className="fea-why1">
            ...
            <Slide direction="right" delay={1}>
              <img
                src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697562673/4861083_bi0yns.jpg"
                alt="img2"
                className="img32"
              />
            </Slide>
