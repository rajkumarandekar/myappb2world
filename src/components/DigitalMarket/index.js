    ...
    <>
      ...
      <div className="main-web-dynamic1">
        <div className="main-web-dynamic">
          <img
            src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697568776/black-7717487_1920_cbfzc5.jpg"
            className="dwaed"
            alt="ed"
          />
        ...
        <div className="desc1">
          ...
          <Slide direction="right" delay={1}>
            <img
              src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697568205/marketing-digital_j6pzi9.jpg"
              className="img-w"
              alt="d"
            />
          </Slide>
        ...
        <div className="why1">
          ...
          <div className="why-img-des1">
            ...
            <Slide direction="right" delay={1}>
              <img
                src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697568259/digital-marketing-training-in-bangalore_wdsoc3.png"
                alt="img22"
                className="img20"
              />
            </Slide>
          ...
          <div className="fea-why1">
            ...
            <Slide direction="right" delay={1}>
              <img
                src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697568213/marketing-digital_vwucn7.jpg"
                alt="img2"
                className="img32"
              />
            </Slide>
