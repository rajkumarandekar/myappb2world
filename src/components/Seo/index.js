    ...
    <>
      ...
      <div className="main-web-dynamic1">
        <div className="main-web-dynamic">
          <img
            src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697564149/seo-2394237_1280_zxsdmq.jpg"
            className="dwaed"
            alt="ed"
          />
        ...
        <div className="desc1">
          ...
          <Slide direction="right" delay={1}>
            <img
              src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697564119/pexels-pixabay-270637_pdhvih.jpg"
              className="img-w"
              alt="d"
            />
          </Slide>
        ...
        <div className="why1">
          ...
          <div className="why-img-des1">
            ...
            <Slide direction="right" delay={1}>
              <img
                src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697564125/seo-1693090_1280_fbwisu.png"
                alt="img22"
                className="img20"
              />
            </Slide>
          ...
          <div className="fea-why1">
            ...
            <Slide direction="right" delay={1}>
              <img
                src="https://res.cloudinary.com/dofzu13gt/image/upload/v1697564135/seo-592740_1280_ceb5iz.png"
                alt="img2"
                className="img32"
              />
            </Slide>
